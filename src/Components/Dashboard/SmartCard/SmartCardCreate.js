...
const SmartCardCreate = () => {
    ...
    const addExperience = (e) => {
        ...
        if(designation != '' && companyName != '' && companyCity != "" && companyCountry != '' && startDate != '' && endDate != '') {
            setExperiences(prev => [...prev , {designation: designation, companyName: companyName, city: companyCity, country: companyCountry, startedAt: startDate, endedAt: endDate}]);
            setDesignation('');
            setCompanyName('');
            setComanyCity('');
            setCompanyCountry('');
    ...
    const addReference = (e) => {
        ...
        if(referenceName != '' && referenceDesignation!= '' && referenceCompany != "" && referenceEmail != "") {
            ...
            console.log('please fill mihandleSubmit1ssing details')
            alert('please fill missing details')
        }
    }
    ...
    const handleSubmit1 = async(e) => {
        ...
        convertedImage = await Convert(image)}
            ...
            convertedImage='https://i.ibb.co/4f9hRhV/download.jpg'
        }
            const d = {
                ...
                <h4>Contact</h4>
                    <div className="row">
                        ...
                        <div className="col-75">
                            <input autoComplete="off" type="text" id="fname" name="firstname" placeholder="Your First Name.." onChange={(e) => setFirstName(e.target.value)}/>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-20">
                    ...
                    <div className="row">
                        ...
                        <div className="col-75">
                            <textarea type="text" id="techSkills" name="techSkills" placeholder="Your Tech Skills" onChange={(e) => changeTechSkill(e.target.value)}/>
                        </div>
                    </div>
                        ...
                        return (
                            <span key={index}>
                             <RemoveButton heading={`Experience ${index+1}`}  index={index}  />
                                ...
                                <div className="row">
                                    <div className="col-20">
                                        <span for="companyName">Company Name</span>
                                    </div>
                                    <div className="col-75">
                                ...
                                <div className="row">
                                    <div className="col-20">
                                        <span for="companyCity">Company City</span>
                                    </div>
                                    <div className="col-75">
                                ...
                                <div className="row">
                                    <div className="col-20">
                                        <span for="companyCountry">Company Country</span>
                                    </div>
                                    <div className="col-75">
                    ...
                    {educations.map((education, index) => {
                        return (
                            ...
                            <RemoveButton heading={`Education ${index+1}`} index={index} />
                                ...
                                <div className="row">
                                    <div className="col-20">
                                        <span for="companyName">College/University Name</span>
                                    </div>
                                    <div className="col-75">
                                ...
                                <div className="row">
                                    <div className="col-20">
                                        <span for="collegeCity">College City</span>
                                    </div>
                                    <div className="col-75">
                                ...
                                <div className="row">
                                    <div className="col-20">
                                        <span for="companyCountry">College Country</span>
                                    </div>
                                    <div className="col-75">
                    ...
                    <div className="row">
                        ...
                        <div className="col-75">
                            {/* <textarea type="text" id="score" name="score" placeholder="Your Interest" value={interest} onChange={(e) => setInterest(e.target.value)}/> */}
                    ...
                    {projects.map((project, index) => {
                        return (
                            ...
                            <RemoveButton heading={`Project ${index+1}`} index={index}  />
                                <div className="row">
                                    <div className="col-20">
                                        <span for="projectNumber">Project Number</span>
                                    </div>
                                    <div className="col-75">
                                ...
                                <div className="row">
                                    <div className="col-20">
                                        <span for="projectTitle">Project Title</span>
                                    </div>
                                    <div className="col-75">
                                ...
                                <div className="row">
                        <div className="col-20">
                            <span for="endDate">Project Description</span>
                        </div>
                        <div className="col-75">
                    ...
                    {volunteerExperiences?.map((volunteer, index) => {
                        return (
                            ...
                            <RemoveButton heading={`Volunteer Experience ${index+1}`} index={index}  />
                                <div className="row">
                                    <div className="col-20">
                                        <span for="projectNumber">Designation</span>
                                    </div>
                                    <div className="col-75">
                                ...
                                <div className="row">
                                    <div className="col-20">
                                        <span for="projectTitle">Company Name</span>
                                    </div>
                                    <div className="col-75">
                    ...
                    {/* <div className='row'>
                                <div className='col-20'>
                                    <span>Honor & Awars</span>
                                </div>
                                <div className='col-75'>
                                    <span>{honorsAndAwards}</span>
                                </div>
                    ...
                    {trainings?.map((training, index) => {
                        ...
                        return (
                            ...
                            <RemoveButton heading={`Training ${index+1}`} index={index} />
                                <div className="row">
                                    <div className="col-20">
                                        <span for="institutionTitle">Title</span>
                                    </div>
                                    <div className="col-75">
                                ...
                                <div className="row">
                                    <div className="col-20">
                                        <span for="institutionName">Institution Name</span>
                                    </div>
                                    <div className="col-75">
                    ...
                    {/* Certification */}
                    <h4>Certification</h4>
                    {/* <SmartCardHeading heading='Certification' handleSubmit={addCertification} /> */}
                    {certifications?.map((certification, index )=> {
                        ...
                        return (
                            ...
                            <RemoveButton heading={`Certification ${index+1}`} index={index} />
                                <div className="row">
                                    <div className="col-20">
                                        <span for="certificationTitle">Title</span>
                                    </div>
                                    <div className="col-75">
                                ...
                                <div className="row">
                                    <div className="col-20">
                                        <span for="certificationName">Institution Name</span>
                                    </div>
                                    <div className="col-75">
                    ...
                    <div className="row">
                        ...
                        <div className="col-75">
                            <input autoComplete="off" type="text" id="courseName" name="courseName" placeholder="Your Institute Name" value={courseInstutionName} onChange={(e) => setCourseInstutionName(e.target.value)}/>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-20">
                    ...
                    {patents?.map((patent, index) => {
                        ...
                        return (
                            ...
                            <RemoveButton heading={`Patent ${index+1}`} index={index} />
                                ...
                                <div className="row">
                                    <div className="col-20">
                                        <span for="patentStatus">Patent Status</span>
                                    </div>
                                    <div className="col-75">
                    ...
                    <div className="row">
                        ...
                        <div className="col-75">
                            <select id="patentStatus" name="patentStatus" value={patentStatus} onChange={e => setPatentStatus(e.target.value)}>
                    ...
                    {references?.map((reference, index) => {
                        ...
                        return (
                            ...
                            <RemoveButton heading={`Reference ${index+1}`} index={index} />
                                <div className="row">
                                    <div className="col-20">
                                        <span for="certificationTitle">Name</span>
                                    </div>
                                    <div className="col-75">
                                ...
                                <div className="row">
                                    <div className="col-20">
                                        <span for="certificationName">Designation</span>
                                    </div>
                                    <div className="col-75">
